...
const Home = () => {
    return (
        <main className="container">
            ...
            <h1 className="text-center m-3 text-light text-decoration-underline" style={{ fontFamily: 'Megrim', fontSize: '400%' }}>
                Elliott Parker</h1>
            <h3 className="text-center m-3 text-light" style={{ fontFamily: 'Mohave' }}>
                Web Development Student | Innovate Birmingham</h3>
            <div className="container d-flex flex-wrap justify-content-center">
                <div className="col-12 d-flex justify-content-center">
                    <a href="https://www.linkedin.com/in/elliott-parker-56b23b139" target="_blank" rel="noreferrer" className="btn text-light m-2" style={{ backgroundColor: 'sienna' }}><BsLinkedin /> LinkedIn</a>
                    <a href="https://github.com/kparker1848" target="_blank" rel="noreferrer" className="btn text-light m-2" style={{ backgroundColor: 'sienna' }}><BsGithub /> Github</a>
                </div>
