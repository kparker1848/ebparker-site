    ...
    return (
        <main className="container">
            ...
            <div className="container d-flex flex-wrap justify-content-center">
                ...
                <div className="col-sm-6 m-4 p-3 d-flex flex-wrap justify-content-center bg-darkpine transparent-box">
                ...
                <div className="col-12 d-flex flex-wrap m-3 justify-content-evenly">
                    ...
                    <div className="card shadow p-3 mb-5 rounded col-sm-4 bg-dustyrose transparent-box">
